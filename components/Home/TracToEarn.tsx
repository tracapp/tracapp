        ...
        <div className='flex flex-col-reverse items-center lg:flex-row gap-5 2xl:gap-14 3xl:container mx-auto'>
          ...
          <div className='w-full lg:w-5/12'>
            <div className='pb-8 md:pb-16 px-6 md:px-0'>
              <h2 className='font-black italic text-[28px]  lg:text-[40px]  xl:text-[42px] 2xl:text-[58px] leading-[1.6] text-brand-dark-100 uppercase' ><span className='text-brand-red'>trac</span>-to-earn </h2>
