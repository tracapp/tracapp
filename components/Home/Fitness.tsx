  ...
  <section className='lg:pl-20 bg-cover bg-left-top bg-[url(/images/banner-bg.png)]'>
        <div className='flex flex-col-reverse lg:flex-row gap-8 3xl:container mx-auto'>
          <div className='w-full lg:w-5/12 px-6 md:px-20 lg:px-0'>
            ...
            <h2 className='font-black italic text-[30px] xl:text-[48px]  2xl:text-[58px] leading-[1.2] text-brand-dark-100 -mt-24 pl-6 md:pl-0 pb-10 md:pb-0 md:-mt-12 xl:-mt-20 2xl:-mt-28 uppercase 2xl:pl-8' ><span className='text-brand-red'>Trac</span> Your Fitness  </h2>
