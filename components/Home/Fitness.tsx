          ...
          <div className='w-full lg:w-5/12 px-6 md:px-20 lg:px-0'>
            ...
            <div className='flex gap-3 md:flex-col'>
              <div className='pb-5 2xl:pl-8'>
                <h5 className='text-[8px] sm:text-lg italic font-medium md:pb-2 text-brand-dark-100'>AUDITED BY</h5>
                <div className='flex items-center gap-2 sm:gap-5'>
                  <a  href="https://coinsult.net/projects/trac/" target='_blank' rel="noopener noreferrer"> <img src="/images/logos/coinsults.svg" alt="coinsults.svg" /></a>
                </div>
              </div>
