     ...
     <section className='px-20 pb-14'>
       <div className='flex justify-center -mt-20 pt-36 bg-left-top bg-no-repeat lg:bg-[url(/images/gameplay.png)]'>
              <div className='pb-16 px-6 md:px-0'>
                <h2 className='font-black italic text-[28px] lg:text-[40px]  xl:text-[42px] 2xl:text-[58px] leading-[1.8] text-brand-dark-100 relative z-20 uppercase text-center' >  <span className='text-brand-red'>game </span>   features </h2>
