        ...
        <div className='3xl:container   mx-auto ' > 
            <div className='flex justify-center'>
              <div className='pb-16 px-6 md:px-0'>
                <h2 className='font-black italic text-[28px] lg:text-[40px]  xl:text-[42px] 2xl:text-[58px] leading-[1.8] text-text-brand-dark-100 relative z-20 uppercase  text-center' > game <span className='text-brand-red'>tokens</span>   </h2>
