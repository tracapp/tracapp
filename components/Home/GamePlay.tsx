          ...
          <div className='3xl:container pb-20 mx-auto' > 
              <div className='flex justify-center'>
                <div className='pb-16 px-6 md:px-0'>
                  <h2 className='font-black italic text-[28px] lg:text-[40px] xl:text-[42px] 2xl:text-[58px] leading-[1.8] text-brand-dark-100 uppercase relative z-20' ><span className='text-brand-red'>trac</span> gameplay </h2>
              ...
              <div className='grid grid-cols-3 gap-10 xl:gap-40 xl:-mt-10 2xl:-mt-32'>
                  <div className='relative w-80 px-5 -mt-10 2xl:ml-36'> 
                    ...
                    <div className='pt-5 relative z-20'>
                      <h2 className='text-[26px] font-black italic text-white shadow-desktop pb-2'>REGISTER</h2>
                  ...
                  <div className='relative w-80 px-5 mt-10 2xl:mt-20 ml-0'> 
                    ...
                    <div className='pt-5 relative z-20'>
                      <h2 className='text-[26px] font-black italic text-white shadow-desktop pb-2'>MARKETPLACE</h2>
                  ...
                  <div className='relative w-80 px-5 -mt-14'> 
                    ...
                    <div className='pt-20  pl-5 2xl:pl-0 2xl:pt-5 relative z-20'>
                      <h2 className='text-[26px] font-black italic text-white shadow-desktop pb-2'>TRAC AND EARN</h2>
